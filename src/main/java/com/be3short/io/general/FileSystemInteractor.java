package com.be3short.io.general;
...
public class FileSystemInteractor
{
	...
	public static boolean checkDirectory(String directory_path, boolean create_if_missing)
	{
		...
		return checkDirectory(theDir, create_if_missing);
	}

	public static boolean checkDirectory(File directory, boolean create_if_missing)
	{
		File theDir = directory;
